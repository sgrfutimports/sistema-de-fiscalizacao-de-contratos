    ...
    <div className="min-h-screen bg-[#050A06] text-white relative overflow-x-hidden font-sans selection:bg-[#fedf00] selection:text-black pb-24">
      ...
      <main className="relative z-10 w-full max-w-md mx-auto px-5 pt-4 flex flex-col items-center text-center">
        ...
        <p className="text-zinc-400 text-[0.95rem] leading-relaxed mb-10 max-w-[300px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '300ms' }}>
          Interface dedicada para avaliação rápida, relatórios nativos e aprovação de serviços de onde você estiver.
        </p>

        {/* Mockup do App (Imagem Premium Plano B) */}
        <div className="w-full relative flex justify-center mb-12 animate-in fade-in zoom-in-95 duration-1000" style={{ animationDelay: '400ms' }}>
          ...
          <div className="relative w-[280px] h-[550px] md:w-[320px] md:h-[620px] rounded-[3rem] overflow-hidden border-[6px] border-[#1a1a1a] shadow-[0_30px_60px_rgba(0,155,58,0.2)] bg-black z-0 group">
            {/* Imagem Realista da Aplicação */}
            <Image 
        ...
        <div className="w-full animate-in fade-in slide-in-from-bottom-8 duration-1000" style={{ animationDelay: '600ms' }}>
          <Link 
            href="/dashboard" 
      ...
      <section className="relative z-10 w-full max-w-md mx-auto px-5 mt-16 pb-12">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000" style={{ animationDelay: '700ms' }}>
          <h2 className="text-xl font-black text-white">Recursos Premium</h2>
        </div>

        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-12 duration-1000" style={{ animationDelay: '800ms' }}>
          
          <div className="p-5 rounded-3xl bg-white/[0.03] border border-white/5 flex flex-col items-start gap-4">
            <div className="h-12 w-12 rounded-full bg-[#fedf00]/10 flex items-center justify-center border border-[#fedf00]/20">
              <FileSignature className="h-5 w-5 text-[#fedf00]" />
            </div>
            <div>
              <h3 className="text-sm font-bold text-white mb-1.5">Avaliação<br/>Ágil</h3>
              <p className="text-zinc-500 text-[0.7rem] leading-relaxed">Etapas simplificadas para nota de serviço.</p>
            </div>
          </div>

          <div className="p-5 rounded-3xl bg-white/[0.03] border border-white/5 flex flex-col items-start gap-4">
            <div className="h-12 w-12 rounded-full bg-[#009b3a]/10 flex items-center justify-center border border-[#009b3a]/20">
              <FileText className="h-5 w-5 text-[#009b3a]" />
            </div>
            <div>
              <h3 className="text-sm font-bold text-white mb-1.5">PDFs<br/>Oficiais</h3>
              <p className="text-zinc-500 text-[0.7rem] leading-relaxed">Exportação pronta para impressão.</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-3xl bg-white/[0.03] border border-white/5 flex flex-col items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-white mb-1.5">App de<br/>Bolso</h3>
              <p className="text-zinc-500 text-[0.7rem] leading-relaxed">Instale nativamente no celular via PWA.</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-3xl bg-white/[0.03] border border-white/5 flex flex-col items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-white mb-1.5">Histórico<br/>Rápido</h3>
              <p className="text-zinc-500 text-[0.7rem] leading-relaxed">Consulte meses anteriores em 1 clique.</p>
            </div>
          </div>
