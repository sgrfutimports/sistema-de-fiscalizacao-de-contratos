  ...
  return (
    <div className="min-h-screen bg-[#050A06] text-white relative overflow-hidden font-sans selection:bg-[#fedf00] selection:text-black">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="w-full max-w-7xl mx-auto px-6 pt-12 pb-24 flex-1 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 flex flex-col items-start text-left w-full z-20">
            ...
            <h1 className="text-5xl lg:text-7xl font-black tracking-tighter text-white mb-6 leading-[1.1] animate-in fade-in slide-in-from-left-8 duration-1000 fill-mode-both" style={{ animationDelay: '200ms' }}>
              O futuro do <br />
            ...
            <p className="text-zinc-400 text-lg leading-relaxed mb-10 max-w-lg font-medium animate-in fade-in slide-in-from-left-8 duration-1000 fill-mode-both" style={{ animationDelay: '300ms' }}>
            ...
            <div className="flex gap-4 animate-in fade-in slide-in-from-left-8 duration-1000 fill-mode-both" style={{ animationDelay: '400ms' }}>
              <Link 
                href="/dashboard" 
                className="group relative inline-flex items-center justify-center gap-3 bg-[#fedf00] text-[#051006] px-8 py-4 rounded-full text-sm font-black transition-all hover:scale-105 shadow-[0_0_30px_rgba(254,223,0,0.2)] hover:shadow-[0_0_50px_rgba(254,223,0,0.4)] uppercase tracking-widest"
              >
                Entrar no Portal
          ...
          <div className="flex-1 w-full relative h-[400px] lg:h-[600px] animate-in fade-in slide-in-from-right-12 duration-1000 fill-mode-both" style={{ animationDelay: '300ms' }}>
        ...
        <section className="w-full max-w-7xl mx-auto px-6 pb-32">
          <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both" style={{ animationDelay: '500ms' }}>
            <h2 className="text-3xl lg:text-4xl font-black text-white tracking-tight">Projetado para <span className="text-[#fedf00]">Excelência</span></h2>
            <p className="text-zinc-500 mt-4 text-lg">Tudo que o fiscal precisa em um mosaico de funcionalidades inteligentes.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px] animate-in fade-in slide-in-from-bottom-12 duration-1000 fill-mode-both" style={{ animationDelay: '600ms' }}>
            ...
            <div className="md:col-span-2 relative p-8 rounded-[2rem] bg-gradient-to-br from-white/[0.04] to-transparent border border-white/5 hover:border-white/10 transition-colors overflow-hidden group flex flex-col justify-end">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Avaliação Descomplicada</h3>
              <p className="text-zinc-400 max-w-md">Preenchimento de notas e critérios através de uma interface step-by-step hiper fluida.</p>
            </div>
            ...
            <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-[#009b3a]/10 to-transparent border border-[#009b3a]/20 hover:border-[#009b3a]/40 transition-colors overflow-hidden group flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-white mb-2">PDFs Nativos</h3>
              <p className="text-zinc-400 text-sm">Geração automática de relatórios no padrão EB.</p>
            </div>
            ...
            <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-white/[0.04] to-transparent border border-white/5 hover:border-white/10 transition-colors overflow-hidden group flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Prazos Inteligentes</h3>
              <p className="text-zinc-400 text-sm">Alertas prévios antes do vencimento do relatório.</p>
            </div>
            ...
            <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-white/[0.04] to-transparent border border-white/5 hover:border-white/10 transition-colors overflow-hidden group flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Histórico Universal</h3>
              <p className="text-zinc-400 text-sm">Consulte o passado da empresa em 1 clique.</p>
            </div>
            ...
            <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-[#fedf00]/10 to-transparent border border-[#fedf00]/20 hover:border-[#fedf00]/40 transition-colors overflow-hidden group flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-[#fedf00] mb-2">100% Mobile & PWA</h3>
              <p className="text-zinc-300 text-sm">Instale o aplicativo direto na tela inicial do seu celular e fiscalize de qualquer pavilhão.</p>
            </div>
