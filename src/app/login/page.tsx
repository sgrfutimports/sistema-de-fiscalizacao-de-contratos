...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0b1d0c] p-4 sm:p-8 py-10 relative overflow-y-auto">
      ...
      <div className="absolute top-[-20%] left-[-10%] h-[500px] w-[500px] rounded-full bg-white/5 blur-[100px] pointer-events-none z-0" />
      <div className="absolute bottom-[-20%] right-[-10%] h-[400px] w-[400px] rounded-full bg-yellow-500/10 blur-[120px] pointer-events-none z-0" />

      <div className="relative z-50 w-full flex flex-col items-center justify-center gap-6">
        <div style={{ 
